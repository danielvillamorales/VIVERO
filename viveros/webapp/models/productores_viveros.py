...
class Productores_viveros(models.Model):
    productores = models.ForeignKey(Productores, on_delete=models.SET_NULL, null=True,unique=True)
    viveros = models.ForeignKey(Viveros, on_delete=models.SET_NULL, null=True,unique=True)
