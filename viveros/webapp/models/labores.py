...
class Labores(models.Model):
    ...
    tipo_labores = models.ForeignKey(Tiposlabores, on_delete=models.SET_NULL, null=True)
    productos_control = models.ForeignKey(Productoscontrol, on_delete=models.SET_NULL, null=True)
